 ...
 * @since Release 9.8.0
 */
class FileExtensionValueResolver implements ValueResolverInterface
{
    public function __construct(
        protected array $valuesAllowed = [],
    ...
    public function resolve(string $argumentName, InputInterface $input, ReflectionMember $member): iterable
    {
        ...
        foreach ($values as $value) {
            if (count($this->valuesAllowed) && !in_array($value, $this->valuesAllowed, true)) {
                return [];
            }
        }
